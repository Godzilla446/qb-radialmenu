print("^2Godzilla-Radialmenu ^1v^0"..GetResourceMetadata(GetCurrentResourceName(), 'version', nil):gsub("%.", "^1.^0").."^7 - ^2Radialmenu Script by ^1Godzilla446^7")
...
Config.VehicleDoors = {
    ...
    icon = 'car',
    type = 'client',
    event = 'qb-vehiclemenu:client:open',
    shouldClose = true
}
